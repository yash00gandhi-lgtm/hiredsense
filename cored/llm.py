...
def generate_ai_report(resume_file_path, job_title, job_desc, job_skills):
    ...
    for skill in missing_skills[:4]:
        interview_questions.append({
            "q": f"Can you explain your experience with {skill}?",
            "ideal_answer": f"Candidate should demonstrate practical knowledge of {skill} with real project examples."
        })

    improvements = [f"Add {s} to your skillset and projects" for s in missing_skills[:3]]
